...
MARKET_HOLIDAY_P  = '本日9/3(木)は主要市場（米・英・日・欧州・豪・NZ・加）すべて通常取引。'
KEY_EVENTS_ITEMS  = [
    '10:30 🇦🇺 貿易収支',
    '21:30 🇺🇸 新規失業保険申請件数',
    '21:30 🇺🇸 貿易収支',
...
REPORT_SUMMARY = '日銀タカ派発言と米ADP下振れでドル円158円台、米雇用・景況感指標が21〜23時台に集中'
RISK_LEVEL = 'MEDIUM'
...
BOC_RATE   = '2.25%';      BOC_STANCE = '中立（7/15会合で据え置き・次回9/2）'; BOC_COLOR = 'var(--muted)'
