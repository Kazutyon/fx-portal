...
TODAY      = '2026-07-09'
WEEKDAY    = '木'
HERO_SUB   = '米軍のイラン追加空爆と原油急伸を受けた有事のドル買いでUSD/JPYは162円30銭台まで上昇。同時刻公表のFOMC議事要旨もタカ派内容でドルを下支えし、地政学材料主導の展開を想定。'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '本日7/9、主要国市場の休場予定なし。通常通り取引可能。'
KEY_EVENTS_ITEMS  = [
    '03:00 🇺🇸 FOMC議事要旨（6/16-17開催分・発表済み）',
    '15:00 🇯🇵 工作機械受注（6月分・確報、要確認）',
    '21:30 🇺🇸 新規失業保険申請件数（7/4週・前回21.5万件）',
    '21:30 🇺🇸 失業保険継続受給者数（要確認）',
]
REPORT_SUMMARY = 'イラン情勢緊迫化で原油急伸、USD/JPY162円台後半 FOMC議事要旨はタカ派'
RISK_LEVEL = 'HIGH'
