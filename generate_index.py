...
TODAY      = '2026-07-22'
WEEKDAY    = '水'
HERO_SUB   = '中東情勢緊迫化と原油高を背景にドル買いが継続し、ドル円は163.239円まで上昇して1986年以来（約39年7カ月ぶり）の高値水準。163円台では実弾介入への警戒感が強まる中、本日は英消費者物価指数（CPI）と米週間原油在庫が焦点。'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日7/22は日米欧・主要市場すべて通常営業（要確認範囲内で祝日情報なし）'
KEY_EVENTS_ITEMS  = [
    '08:50 🇯🇵 6月 貿易収支（通関ベース）予想-1200億円',
    '15:00 🇬🇧 6月 消費者物価指数（CPI）前年比 予想+2.7%',
    '23:30 🇺🇸 週間原油在庫',
]
REPORT_SUMMARY = '中東緊迫・原油高でドル円39年ぶり高値'
RISK_LEVEL = 'HIGH'
