...
TODAY      = '2026-07-23'
WEEKDAY    = '木'
HERO_SUB   = '前日NY市場はドル円163.15円でほぼ横ばい。原油高・米長期金利上昇の円売り圧力と、トランプ大統領のイラン警告による上値抑制が拮抗した。本日最大の焦点は21:15のECB理事会（据え置き観測）とラガルド総裁会見で、ユーロの方向を決める。朝方は豪雇用統計、夜は米新規失業保険・カナダ小売にも注目。'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日7/23は日米欧・主要市場すべて通常営業（要確認範囲内で祝日情報なし）'
KEY_EVENTS_ITEMS  = [
    '10:30 🇦🇺 6月 失業率 予想4.4%・新規雇用者数 予想+1.50万人',
    '21:15 🇪🇺 ECB政策金利＆声明（据え置き観測・要確認）',
    '21:30 🇺🇸 週間新規失業保険申請件数 予想21.2万件',
    '21:30 🇨🇦 5月 小売売上高 予想+1.0%',
    '21:45 🇪🇺 ラガルドECB総裁 記者会見',
]
REPORT_SUMMARY = 'ECB理事会待ち、ユーロ次第の一日'
RISK_LEVEL = 'MEDIUM'
