...
TODAY      = '2026-07-08'
WEEKDAY    = '水'
HERO_SUB   = 'FOMC議事要旨（翌3:00発表）を控え材料難のなか、USD/JPYは162円台前半でのもみ合いを想定。日本10年債利回りの上昇継続が円売り地合いを下支え。'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '本日7/8、主要国市場の休場予定なし。通常通り取引可能。'
KEY_EVENTS_ITEMS  = [
    '08:30 🇯🇵 毎月勤労統計-現金給与総額（5月）',
    '08:30 🇯🇵 全世帯家計調査（5月）',
    '14:00 🇯🇵 景気動向指数速報（5月）',
    '23:00 🇺🇸 5月卸売売上高（要確認）',
    '翌3:00(7/9) 🇺🇸 FOMC議事要旨（6月開催分・要確認：対象会合）',
]
REPORT_SUMMARY = 'FOMC議事要旨控え、162円台前半でもみ合い'
RISK_LEVEL = 'MEDIUM'
