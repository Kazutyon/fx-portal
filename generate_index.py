...
TODAY      = '2026-09-18'
WEEKDAY    = '金'
HERO_SUB   = '前日はFOMC後のドル高が一服しドル円は155.97円まで反落、英BOEは3.75%据え置きも6対3の分裂投票でハト派的と受け止められポンド安。本日は正午前後に日銀が政策金利を発表、25bp利上げで1.25%への引き上げが市場予想（KissFX・ForexFactory一致）'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日9/18（金）、主要国の市場休場はありません。'
KEY_EVENTS_ITEMS  = [
    '08:30 🇯🇵 全国消費者物価指数(CPI)',
    '11:30 🇯🇵 BOJ政策金利＆声明発表',
    '15:00 🇬🇧 英国 小売売上高',
    '15:30 🇯🇵 植田日銀総裁 記者会見（要確認）',
    '22:15 🇺🇸 米国 鉱工業生産',
    '23:00 🇺🇸 米国 景気先行指数',
]
REPORT_SUMMARY = '日銀が本日正午前後に政策金利発表、25bp利上げで1.25%が市場予想。前日はFOMC後のドル高一服でドル円反落、BOEはハト派的でポンド安'
RISK_LEVEL = 'HIGH'
FRB_RATE   = '3.75–4.00%'; FRB_STANCE = 'タカ派（9/16FOMCで0.25%利上げ実施・2023年以来3年ぶり、声明・会見をタカ派的と受け止めドル全面高）'; FRB_COLOR = 'var(--red)'
BOE_RATE   = '3.75%';      BOE_STANCE = '中立〜ハト派（9/17据え置き決定・9人中3人が4.00%への利上げを主張する6対3の分裂投票、総合的にハト派的と受け止められポンド安）'; BOE_COLOR = 'var(--muted)'
BOJ_RATE   = '1.00%';      BOJ_STANCE = '正常化継続・タカ派寄り（本日11:30ごろ政策金利発表予定、25bp利上げで1.25%への引き上げが市場予想＝KissFX・ForexFactory一致）'; BOJ_COLOR = 'var(--blue)'
