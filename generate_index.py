...
TODAY      = '2026-09-02'
WEEKDAY    = '水'
HERO_SUB   = '前日はJOLTS下方修正・ISM下振れも、米軍のイラン攻撃で有事のドル買いが優勢に転換しドル円は160円18銭で反発。本日はRBNZ・BOC政策金利発表が重なる中銀デーで振れやすい一日に。'
MARKET_HOLIDAY_H3 = '休場市場はなし'
MARKET_HOLIDAY_P  = '本日9/2(水)は主要市場（米・英・日・欧州・豪・NZ・加）すべて通常取引。'
KEY_EVENTS_ITEMS  = [
    '10:30 🇦🇺 GDP【第2四半期】',
    '11:00 🇳🇿 RBNZ政策金利発表',
    '21:15 🇺🇸 ADP雇用統計',
...
REPORT_SUMMARY = 'RBNZ・BOC政策金利発表が重なる中銀デー、有事のドル買いで160円台'
RISK_LEVEL = 'HIGH'
