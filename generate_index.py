...
TODAY      = '2026-08-27'
WEEKDAY    = '木'
HERO_SUB   = '前日はNVIDIA決算が市場予想を上回る増収でも時間外で株価が下落し、ドル円は原油急落と中東情勢改善観測を受けた米長期金利低下で159円台前半を上下した。本日は氷見野日銀副総裁の講演が9月利上げ観測を左右する最大の注目材料となるほか、ECB理事会議事要旨や米新規失業保険申請件数が予定され、28日のジャクソンホール会合ウォーシュ議長講演を控えたポジション調整含みの展開が続く。'
...
REPORT_SUMMARY = '氷見野講演が9月利上げ観測を左右、ジャクソンホール会合控え調整継続'
RISK_LEVEL = 'MEDIUM'
