...
TODAY      = '2026-06-30'
WEEKDAY    = '火'
HERO_SUB   = '日銀短観Q2・シントラ中銀講演・月末フィキシング——円・ユーロ・ポンドの方向性が今日決まる。'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '全主要市場は通常営業（翌7/3は米独立記念日の連休で流動性低下に注意）'
KEY_EVENTS_ITEMS  = [
    '08:00 🇯🇵 日銀短観 Q2 大企業製造業DI（予想+15）',
    '08:00 🇨🇳 中国 NBS製造業PMI（6月・予想50.1）',
    '15:00 🇬🇧 英国 GDP確報値 Q1（予想+0.6%）',
    '17:00 🇩🇪 ドイツ CPI速報値（HICP・6月）',
    '終日 🌍 ECBラガルド・FRBウォーシュ シントラ講演',
    '22:45 🇺🇸 シカゴPMI（6月・前回62.7）',
    '23:00 🇺🇸 CB消費者信頼感指数（6月）',
]
REPORT_SUMMARY = '日銀短観×シントラ中銀講演。USD/JPY 162円介入ライン攻防。'
RISK_LEVEL = 'HIGH'
