...
TODAY      = '2026-09-17'
WEEKDAY    = '木'
HERO_SUB   = 'FOMCが0.25%利上げでFFレート3.75〜4.00%に（2023年以来3年ぶり）。声明・会見がタカ派的と受け止められドル全面高、ドル円は一時156.14円。本日は英BOE政策金利発表と米重要指標が集中'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日9/17（木）、主要国の市場休場はありません。'
KEY_EVENTS_ITEMS  = [
    '07:45 🇳🇿 NZ第2四半期GDP',
    '20:00 🇬🇧 BOE政策金利＆声明発表',
    '21:30 🇺🇸 新規失業保険申請件数',
...
REPORT_SUMMARY = 'FOMC25bp利上げでドル全面高、ドル円156円台。本日はBOE政策金利発表'
RISK_LEVEL = 'HIGH'
FRB_RATE   = '3.75–4.00%'; FRB_STANCE = 'タカ派（9/16FOMCで0.25%利上げ実施・2023年以来3年ぶり、声明・会見をタカ派的と受け止めドル全面高）'; FRB_COLOR = 'var(--red)'
BOE_RATE   = '3.75%';      BOE_STANCE = '中立〜やや引き締め警戒（7/30据え置き5会合連続・本日20:00に政策金利発表）'; BOE_COLOR = 'var(--muted)'
