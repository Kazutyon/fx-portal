...
TODAY      = '2026-09-25'
WEEKDAY    = '金'
HERO_SUB   = 'ドル円は200日線を上抜けて5日続伸・158.86円。160円接近で介入警戒が急上昇、本日はベイリーBOE総裁ら要人発言に注目'
MARKET_HOLIDAY_H3 = '中国（祝日）'
MARKET_HOLIDAY_P  = '中国は祝日で休場（KissFX・ForexFactory一致。具体的な祝日名は要確認）。'
KEY_EVENTS_ITEMS  = [
    '18:15 🇬🇧 英国 ベイリーBOE総裁 発言',
    '18:15 🇺🇸 米国 ウィリアムズNY連銀総裁 発言（投票権あり）',
    '21:30 🇺🇸 米国 耐久財受注',
    '22:20 🇺🇸 米国 シュミッドカンザスシティ連銀総裁 発言',
    '23:00 🇺🇸 米国 ミシガン大学消費者信頼感指数【確報値】',
    '27:00 🇺🇸 米国 ハマッククリーブランド連銀総裁 発言（投票権あり）',
]
REPORT_SUMMARY = 'ドル円200日線上抜け5日続伸、160円接近で介入警戒'
RISK_LEVEL = 'HIGH'
FRB_RATE   = '3.75–4.00%'; FRB_STANCE = 'タカ派（9/16FOMCで0.25%利上げ・全会一致、9/23の強いPMIを受け10月追加利上げ観測が上昇）'; FRB_COLOR = 'var(--red)'
...
SNB_RATE   = '0.00%';      SNB_STANCE = 'ハト派〜中立（9/24に政策金利発表、据え置き予想。発表後の確定結果は本日時点で複数ソース確認できず・要確認）'; SNB_COLOR = 'var(--muted)'
# ────────────────────────────────────────────────────────
