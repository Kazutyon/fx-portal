...
TODAY      = '2026-07-28'
WEEKDAY    = '火'
HERO_SUB   = 'FOMC（7/28-29）が本日開幕、政策判断は明日29日に持ち越し。ドル円は前日NY市場での小幅続落（163.75円）を引き継ぎ、東京朝は163.70円台で推移。米・イラン協議を巡る報道が交錯するなか、正午のRBAブロック総裁発言と夜間の米消費者信頼感指数に注目。'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日7/28はForexFactory休場カレンダーに該当なし。日米欧・主要市場は通常営業（確認できた範囲で祝日情報なし）'
KEY_EVENTS_ITEMS  = [
    '12:05 🇦🇺 RBAブロック総裁発言（重要度High）',
    '14:00 🇯🇵 日銀コアCPI前年比（要確認）',
    '23:00 🇺🇸 消費者信頼感指数（CB） 予想92.4',
    '23:00 🇺🇸 リッチモンド連銀製造業指数 予想+7',
]
REPORT_SUMMARY = 'FOMC開幕でドル円163.70円台、イラン協議報道は交錯'
RISK_LEVEL = 'MEDIUM'
