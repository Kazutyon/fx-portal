...
TODAY      = '2026-08-25'
WEEKDAY    = '火'
HERO_SUB   = '前日はベッセント財務長官の対イラン制裁発表でドル円が159円20銭台まで切り返す一方、米財務省の長期国債買戻し観測がユーロドルの重石に。本日は経済指標が多く、23:00の米消費者信頼感指数とRBA議事録に注目。'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '本日、主要国の市場休場はありません。'
KEY_EVENTS_ITEMS  = [
    '10:30 🇦🇺 RBA議事録公表（8/10-11開催分）',
    '15:00 🇩🇪 独GDP【改定値】',
    '17:00 🇩🇪 独IFO景況指数',
    '23:00 🇺🇸 消費者信頼感指数',
    '23:00 🇺🇸 新築住宅販売件数',
]
REPORT_SUMMARY = 'ベッセント財務長官のイラン制裁発表でドル円が切り返し、本日は米消費者信頼感指数とRBA議事録に注目'
RISK_LEVEL = 'MEDIUM'
