...
TODAY      = '2026-08-26'
WEEKDAY    = '水'
HERO_SUB   = '前日はウォーシュFRB議長の講演を控えドル円が159円台前半でレンジ推移、米消費者信頼感指数は89.4と1月来の低水準に低下。本日は10:30の豪CPI、21:30の米個人所得・支出・GDP改定値・PCEコア・デフレーターなど米指標が集中し、引け後のNVIDIA決算にも注目が集まる。'
...
REPORT_SUMMARY = '豪CPIと米個人所得・支出・GDP改定値、NVIDIA決算に注目'
RISK_LEVEL = 'MEDIUM'
