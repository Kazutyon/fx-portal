...
WEEKDAY    = '木'
HERO_SUB   = (
    '前日9/9（木）は米国債買い戻し発表と好調な10年債入札でドル円が下げ渋り153円56銭で引ける（5日続落）、'
    '本日は21:15のECB政策金利発表と21:30の米PPIが焦点'
)
...
ECB_RATE   = '2.25%';      ECB_STANCE = 'タカ派（預金ファシリティ金利、本日9/10理事会で0.25%利上げ観測・要確認）'; ECB_COLOR = 'var(--red)'
