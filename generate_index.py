...
TODAY      = '2026-09-08'
WEEKDAY    = '火'
HERO_SUB   = '前日9/7（月）は米国・カナダのレイバーデー休場で薄商いのなか、日銀利上げ観測と要人発言を受けてドル円が154円台まで急落。本日は日本GDP改定値と米休場明けの反応に注目'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '本日、主要国の市場休場はありません（前日9/7は米国・カナダがレイバーデーで休場、本日は休場明け）。'
KEY_EVENTS_ITEMS  = [
    '08:50 🇯🇵 GDP【改定値・前期比/年率】',
    '08:50 🇯🇵 経常収支',
    '11:00頃 🇨🇳 貿易収支',
    '14:00 🇯🇵 景気ウォッチャー調査【現状/先行き判断DI】',
    '19:00 🇺🇸 NFIB中小企業楽観指数',
    '22:15 🇬🇧 金融政策report聴聞会',
    '翌02:00 🇺🇸 3年債入札',
]
REPORT_SUMMARY = '前日はBOJ利上げ観測と要人発言でドル円が154円台へ急落、本日は日本GDP改定値と米休場明けの反応に注目'
RISK_LEVEL = 'MEDIUM'
