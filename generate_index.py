...
TODAY      = '2026-09-21'
WEEKDAY    = '月'
HERO_SUB   = '前週末9/18(金)は日銀が0.25%利上げで政策金利1.25%に（反対2）、直後の日銀レートチェック報道で介入警戒が急上昇しドル円は158.05円から156.88円へ反落。本日9/21(月)は敬老の日で日本市場が休場、経済指標は閑散'
MARKET_HOLIDAY_H3 = '日本市場休場（敬老の日）'
MARKET_HOLIDAY_P  = '本日9/21（月）〜23（水）は敬老の日で日本市場が休場（東京証券取引所・銀行休業、日経225先物・オプションは祝日取引あり）。'
KEY_EVENTS_ITEMS  = [
    '終日 🇯🇵 敬老の日で日本市場休場',
    '08:01 🇬🇧 英国 ライトムーブ住宅価格指数',
    '19:30 🇺🇸 米国 グールズビー・シカゴ連銀総裁 発言',
    '24:00 🇪🇺 欧州 ラガルドECB総裁 発言',
    '24:20 🇨🇦 カナダ マックレムBOC総裁 発言（要確認）',
]
REPORT_SUMMARY = '日銀が0.25%利上げで政策金利1.25%に（反対2）。レートチェック報道でドル円は158.05円から156.88円へ反落。本日は敬老の日で日本休場、経済指標は閑散'
RISK_LEVEL = 'MEDIUM'
