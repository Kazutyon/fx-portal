...
TODAY      = '2026-07-21'
WEEKDAY    = '火'
HERO_SUB   = '米イラン軍事衝突は仲介国の10日間停戦提案で外交的な動きもあるが、原油(WTI)は83ドル台まで続伸。ドル円は162円台後半の介入警戒ラインを意識したもみ合いが継続、本日の骨太の方針2026閣議決定を見極める展開。'
MARKET_HOLIDAY_H3 = '休場市場なし'
MARKET_HOLIDAY_P  = '本日7/21は日米欧・主要市場すべて通常営業（要確認範囲内で祝日情報なし）'
KEY_EVENTS_ITEMS  = [
    '07:45 🇳🇿 4-6月期 消費者物価指数（CPI）前年比+4.1%【発表済み・予想上振れ】',
    '18:00 🇩🇪🇪🇺 7月 ZEW景況感指数',
    '終日 🇯🇵 骨太の方針2026 閣議決定（要確認）',
]
REPORT_SUMMARY = '停戦提案と介入警戒でドル円もみ合い'
RISK_LEVEL = 'HIGH'
