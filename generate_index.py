...
TODAY      = '2026-07-01'
WEEKDAY    = '水'
HERO_SUB   = '日銀短観Q2・米ISM製造業景況指数——円とドルの方向性を占う一日。'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '全主要市場は通常営業（7/3は米独立記念日の連休で米国市場休場、週後半は流動性低下に注意）'
KEY_EVENTS_ITEMS  = [
    '08:50 🇯🇵 日銀短観 Q2 大企業製造業DI（予想+14）',
    '10:45 🇨🇳 財新製造業PMI（6月・要確認）',
    '17:00 🇪🇺 ユーロ圏 製造業PMI確報値（6月・予想49.4）',
    '17:30 🇬🇧 英国 製造業PMI確報値（6月・予想54.0）',
    '23:00 🇺🇸 ISM製造業景況指数（6月・予想48.8）',
]
REPORT_SUMMARY = '日銀短観×米ISM製造業。USD/JPY 162円攻防の行方。'
RISK_LEVEL = 'MEDIUM'
# ── 8中銀（火〜金: 既存データ引き継ぎ） ──
