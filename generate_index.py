...
WEEKDAY    = '水'
HERO_SUB   = (
    '前日9/8（火）は日銀の1.25％利上げ方針報道（要確認）と米長期金利の乱高下でドル円が4日続落、'
    '本日は米国発の高重要度指標がなく翌02時台の米10年債入札が焦点'
)
...
KEY_EVENTS_ITEMS  = [
    ...
    '15:00 🇯🇵 工作機械受注【改定・前年比】',
    '15:45 🇫🇷 鉱工業生産【前月比/前年比】',
    '翌02:01 🇺🇸 10年債入札（発行予定額390億ドル）',
]
REPORT_SUMMARY = '日銀1.25%利上げ方針報道(要確認)でドル円4日続落、米10年債入札に注目'
RISK_LEVEL = 'MEDIUM'
