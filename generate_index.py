...
TODAY      = '2026-08-28'
WEEKDAY    = '金'
HERO_SUB   = '前日はドル円が米新規失業保険申請件数の予想比減少と7月卸売在庫速報値の改善を受けたドル買いで4営業日続伸し159円39銭で引けた一方、米7年債入札は最高落札利回り4.512％と2024年来の最高水準まで上昇し低調な結果となった。本日はジャクソンホール会合2日目のウォーシュFRB議長講演が最大の焦点となるほか、東京都区部CPI・カナダGDP・シカゴPMIが重なり、方向感を試す一日となる。'
...
REPORT_SUMMARY = 'ジャクソンホール会合2日目、ウォーシュFRB議長講演が最大の焦点'
RISK_LEVEL = 'HIGH'
