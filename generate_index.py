...
TODAY      = '2026-09-24'
WEEKDAY    = '木'
HERO_SUB   = '米9月PMI速報値の大幅上振れでドル円は4日続伸158.32円。本日はSNB政策金利・豪雇用統計など指標集中'
MARKET_HOLIDAY_H3 = 'なし'
MARKET_HOLIDAY_P  = '日本は9/21〜23の3連休明けで通常取引。中国は明日9/25が祝日のため本日は通常取引（要確認）。'
KEY_EVENTS_ITEMS  = [
    '10:30 🇦🇺 豪州 失業率・新規雇用者数',
...
REPORT_SUMMARY = '米PMI上振れでドル高進行、SNB・豪雇用統計に注目'
RISK_LEVEL = 'MEDIUM'
...
SNB_RATE   = '0.00%';      SNB_STANCE = 'ハト派〜中立（本日9/24 16:30に政策金利発表、据え置き予想）'; SNB_COLOR = 'var(--muted)'
# ────────────────────────────────────────────────────────
